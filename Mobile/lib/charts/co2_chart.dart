...
class CO2ChartPage extends StatefulWidget {
  final String apiKey;
  ...
  @override
  _CO2ChartPageState createState() => _CO2ChartPageState();
}

class _CO2ChartPageState extends State<CO2ChartPage> {
  ...
  Future<void> _fetchData() async {
    final response = await http.get(Uri.parse(
        'https://api.thingspeak.com/channels/${widget.channelId}/fields/3.json?api_key=${widget.apiKey}&results=20'));
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        _seriesData = feeds
            ...
            .entries
            .map((entry) => FlSpot(
                entry.key.toDouble(), double.parse(entry.value['field3'])))
            .toList();
      });
    } else {
